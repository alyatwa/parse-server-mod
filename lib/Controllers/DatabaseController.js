...
class DatabaseController {
  ...
  performInitialization() {
    ...
    const appUniqueness = privaterecordPromise.then(() => this.adapter.ensureUniqueness('PrivateRecord', app, ['objectId'])).catch(error => {
      _logger2.default.warn('Unable to ensure uniqueness for private record: ', error);
      throw error;
    });
    const spamUniqueness = recordsPromise.then(() => this.adapter.ensureUniqueness('Records', spamRecords, ['objectId'])).catch(error => {
      _logger2.default.warn('Unable to ensure uniqueness for records: ', error);
      throw error;
    });
